...
@pytest.mark.parametrize("filter_value, col_name, op, ref_dict",
                         [(1, "int_col", Expressions.equal, dict([('int_col', [1]),
                                                                  ('str_col', ['us']),
                                                                  ('list_col', [[0]]),
                                                                  ('bool_col', [True])])),
                          (3, "int_col", Expressions.less_than_or_equal, dict([('int_col', [1, 2, 3]),
                                                                               ('str_col', ['us', 'can', 'us']),
                                                                               ('list_col', [[0], [1, 2], [1]]),
                                                                               ('bool_col', [True, None, False])])),
                          (3, "int_col", Expressions.less_than, dict([('int_col', [1, 2]),
                                                                      ('str_col', ['us', 'can']),
                                                                      ('list_col', [[0], [1, 2]]),
                                                                      ('bool_col', [True, None])])),
                          (5, "int_col", Expressions.greater_than_or_equal, dict([('int_col', [5]),
                                                                                  ('str_col', ['can']),
                                                                                  ('list_col', [None]),
                                                                                  ('bool_col', [True])])),
                          (2, "int_col", Expressions.greater_than, dict([('int_col', [3, 5]),
                                                                         ('str_col', ['us', 'can']),
                                                                         ('list_col', [[1], None]),
                                                                         ('bool_col', [False, True])]))
                          ])
