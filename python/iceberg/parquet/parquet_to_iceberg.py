...
from iceberg.api.types import (BinaryType,
                               ...
                               StructType,
                               TimestampType)
from pyarrow.parquet import lib
...
def get_nested_field(field_id, field_name, field_type, nullable):
    if nullable:
...
def get_struct_field(col_type):
    if col_type.num_children > 0:
...
def convert_parquet_to_iceberg(parquet_file):  # noqa: ignore=C901
    """
...
def arrow_to_iceberg(arrow_schema):
    """
